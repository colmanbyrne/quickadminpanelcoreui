...
class ExpenseController extends Controller
{
    public function index()
    {
        ...
        $expenses = Expense::with(['expense_category', 'branch', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.expenses.create', compact('expense_categories', 'branches'));
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        $expense->load('expense_category', 'branch', 'created_by');

        return view('frontend.expenses.edit', compact('expense_categories', 'branches', 'expense'));
    }
