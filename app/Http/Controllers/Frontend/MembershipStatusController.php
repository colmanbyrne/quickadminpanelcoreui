...
class MembershipStatusController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.membershipStatuses.index', compact('membershipStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.membershipStatuses.create');
    }
    ...
    public function store(StoreMembershipStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.membership-statuses.index');
    }
    ...
    public function edit(MembershipStatus $membershipStatus)
    {
        ...
        return view('frontend.membershipStatuses.edit', compact('membershipStatus'));
    }
    ...
    public function show(MembershipStatus $membershipStatus)
    {
        ...
        return view('frontend.membershipStatuses.show', compact('membershipStatus'));
    }
