...
class BranchesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.branches.create', compact('branch_secretaries', 'branch_treasurers', 'branch_chairs', 'branch_rep_1s', 'branch_rep_2s'));
    }
    ...
    public function edit(Branch $branch)
    {
        ...
        return view('frontend.branches.edit', compact('branch_secretaries', 'branch_treasurers', 'branch_chairs', 'branch_rep_1s', 'branch_rep_2s', 'branch'));
    }
