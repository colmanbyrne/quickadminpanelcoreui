...
class IncomeCategoryApiController extends Controller
{
    public function index()
    {
        ...
        return new IncomeCategoryResource(IncomeCategory::with(['income_category', 'branch', 'created_by'])->get());
    }
    ...
    public function show(IncomeCategory $incomeCategory)
    {
        ...
        return new IncomeCategoryResource($incomeCategory->load(['income_category', 'branch', 'created_by']));
    }
