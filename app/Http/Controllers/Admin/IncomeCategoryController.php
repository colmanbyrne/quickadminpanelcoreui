...
class IncomeCategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.incomeCategories.create', compact('income_categories', 'branches'));
    }
    ...
    public function edit(IncomeCategory $incomeCategory)
    {
        ...
        return view('admin.incomeCategories.edit', compact('income_categories', 'branches', 'incomeCategory'));
    }
