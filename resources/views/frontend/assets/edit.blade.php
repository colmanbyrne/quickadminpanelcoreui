                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assets.update", [$asset->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="asset_year" id="asset_year" value="{{ old('asset_year', $asset->asset_year) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_purchased" id="date_purchased" value="{{ old('date_purchased', $asset->date_purchased) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="value" id="value" value="{{ old('value', $asset->value) }}" step="0.01">
                            @if($errors->has('value'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('value') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_value" id="date_value" value="{{ old('date_value', $asset->date_value) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="rep_value_date" id="rep_value_date" value="{{ old('rep_value_date', $asset->rep_value_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rep_value" id="rep_value" value="{{ old('rep_value', $asset->rep_value) }}" step="0.01">
