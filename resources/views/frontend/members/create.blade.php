                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.members.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="member_no" id="member_no" value="{{ old('member_no', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="organisation_name" id="organisation_name" value="{{ old('organisation_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="town" id="town" value="{{ old('town', '') }}" required>
                            @if($errors->has('town'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('town') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_code" id="post_code" value="{{ old('post_code', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tel_no" id="tel_no" value="{{ old('tel_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mob_no" id="mob_no" value="{{ old('mob_no', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_status" id="email_status" value="{{ old('email_status', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sms_status" id="sms_status" value="{{ old('sms_status', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mem_year" id="mem_year" value="{{ old('mem_year', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mem_fee" id="mem_fee" value="{{ old('mem_fee', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mem_fee_currency" id="mem_fee_currency" value="{{ old('mem_fee_currency', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pay_method" id="pay_method" value="{{ old('pay_method', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_joined" id="date_joined" value="{{ old('date_joined') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_renewed" id="date_renewed" value="{{ old('date_renewed') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_card_issued" id="date_card_issued" value="{{ old('date_card_issued') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_dd_issued" id="date_dd_issued" value="{{ old('date_dd_issued') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="date_cancelled" id="date_cancelled" value="{{ old('date_cancelled', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="mem_notes" id="mem_notes">{{ old('mem_notes') }}</textarea>
