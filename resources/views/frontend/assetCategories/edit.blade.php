            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.asset-categories.update", [$assetCategory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="required" for="code">{{ trans('cruds.assetCategory.fields.code') }}</label>
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $assetCategory->code) }}" required>
                            @if($errors->has('code'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('code') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.assetCategory.fields.code_helper') }}</span>
                        </div>
                        <div class="form-group">
