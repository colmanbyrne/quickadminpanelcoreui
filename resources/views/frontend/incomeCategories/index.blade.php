                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-IncomeCategory">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.incomeCategory.fields.income_category') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.incomeCategory.fields.branch') }}
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                @foreach($incomeCategories as $key => $incomeCategory)
                                    <tr data-entry-id="{{ $incomeCategory->id }}">
                                        ...
                                        <td>
                                            {{ $incomeCategory->income_category->name ?? '' }}
                                        </td>
                                        <td>
                                            {{ $incomeCategory->branch->shortname ?? '' }}
                                        </td>
                                        <td>
                                            {{ $incomeCategory->branch->branch_no ?? '' }}
                                        </td>
                                        <td>
