                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="income_category_id" id="income_category_id">
                                @foreach($income_categories as $id => $income_category)
                                    <option value="{{ $id }}" {{ (old('income_category_id') ? old('income_category_id') : $incomeCategory->income_category->id ?? '') == $id ? 'selected' : '' }}>{{ $income_category }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="branch_id" id="branch_id">
                                @foreach($branches as $id => $branch)
                                    <option value="{{ $id }}" {{ (old('branch_id') ? old('branch_id') : $incomeCategory->branch->id ?? '') == $id ? 'selected' : '' }}>{{ $branch }}</option>
                                @endforeach
                            </select>
