    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.rally-users.update", [$rallyUser->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="entry_type" id="entry_type" value="{{ old('entry_type', $rallyUser->entry_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="entry_status" id="entry_status" value="{{ old('entry_status', $rallyUser->entry_status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="entry_date" id="entry_date" value="{{ old('entry_date', $rallyUser->entry_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="entry_paid" id="entry_paid" value="{{ old('entry_paid', $rallyUser->entry_paid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_due" id="fee_due" value="{{ old('fee_due', $rallyUser->fee_due) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_paid" id="fee_paid" value="{{ old('fee_paid', $rallyUser->fee_paid) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fee_currency" id="fee_currency" value="{{ old('fee_currency', $rallyUser->fee_currency) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="entry_notes" id="entry_notes">{{ old('entry_notes', $rallyUser->entry_notes) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="entry_comment" id="entry_comment">{{ old('entry_comment', $rallyUser->entry_comment) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="num_adults" id="num_adults" value="{{ old('num_adults', $rallyUser->num_adults) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="num_child_18" id="num_child_18" value="{{ old('num_child_18', $rallyUser->num_child_18) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="num_child_12" id="num_child_12" value="{{ old('num_child_12', $rallyUser->num_child_12) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="opt_dinner_adult" id="opt_dinner_adult" value="{{ old('opt_dinner_adult', $rallyUser->opt_dinner_adult) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="opt_dinner_teen" id="opt_dinner_teen" value="{{ old('opt_dinner_teen', $rallyUser->opt_dinner_teen) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="opt_dinner_child" id="opt_dinner_child" value="{{ old('opt_dinner_child', $rallyUser->opt_dinner_child) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vessel_name" id="vessel_name" value="{{ old('vessel_name', $rallyUser->vessel_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vessel_length" id="vessel_length" value="{{ old('vessel_length', $rallyUser->vessel_length) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vessel_draft" id="vessel_draft" value="{{ old('vessel_draft', $rallyUser->vessel_draft) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vessel_air_draft" id="vessel_air_draft" value="{{ old('vessel_air_draft', $rallyUser->vessel_air_draft) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vcruise_normal" id="vcruise_normal" value="{{ old('vcruise_normal', $rallyUser->vcruise_normal) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="vcruise_max" id="vcruise_max" value="{{ old('vcruise_max', $rallyUser->vcruise_max) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="own_vessel" id="own_vessel" value="{{ old('own_vessel', $rallyUser->own_vessel) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="boat_number" id="boat_number" value="{{ old('boat_number', $rallyUser->boat_number) }}" step="1">
