                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.branches.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="branch_no" id="branch_no" value="{{ old('branch_no', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="longname" id="longname" value="{{ old('longname', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="branch_country" id="branch_country" value="{{ old('branch_country', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="branch_currency" id="branch_currency" value="{{ old('branch_currency', '') }}" required>
