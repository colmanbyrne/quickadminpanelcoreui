    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.membership-categories.update", [$membershipCategory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="category_type">{{ trans('cruds.membershipCategory.fields.category_type') }}</label>
                            <input class="form-control" type="text" name="category_type" id="category_type" value="{{ old('category_type', $membershipCategory->category_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="category_name" id="category_name" value="{{ old('category_name', $membershipCategory->category_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mem_fee" id="mem_fee" value="{{ old('mem_fee', $membershipCategory->mem_fee) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_add" id="fee_add" value="{{ old('fee_add', $membershipCategory->fee_add) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="country_code" id="country_code" value="{{ old('country_code', $membershipCategory->country_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="curr_symbol" id="curr_symbol" value="{{ old('curr_symbol', $membershipCategory->curr_symbol) }}">
