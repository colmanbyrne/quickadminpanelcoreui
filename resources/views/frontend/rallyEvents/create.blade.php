    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.rally-events.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_organiser" id="event_organiser" value="{{ old('event_organiser', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_status" id="event_status" value="{{ old('event_status', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_entries" id="max_entries" value="{{ old('max_entries', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_early_fee" id="date_early_fee" value="{{ old('date_early_fee') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_normal" id="fee_normal" value="{{ old('fee_normal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_early" id="fee_early" value="{{ old('fee_early', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_open" id="fee_open" value="{{ old('fee_open', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_solo" id="fee_solo" value="{{ old('fee_solo', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_new_member" id="fee_new_member" value="{{ old('fee_new_member', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_dinner_adult" id="fee_dinner_adult" value="{{ old('fee_dinner_adult', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_adult_teen" id="fee_adult_teen" value="{{ old('fee_adult_teen', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee_dinner_child" id="fee_dinner_child" value="{{ old('fee_dinner_child', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mem_only" id="mem_only" value="{{ old('mem_only', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_from_name" id="email_from_name" value="{{ old('email_from_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email_from" id="email_from" value="{{ old('email_from') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email_copy" id="email_copy" value="{{ old('email_copy') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="event_comment" id="event_comment">{{ old('event_comment') }}</textarea>
