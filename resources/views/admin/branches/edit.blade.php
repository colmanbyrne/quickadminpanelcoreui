    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.branches.update", [$branch->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_no') ? 'is-invalid' : '' }}" type="number" name="branch_no" id="branch_no" value="{{ old('branch_no', $branch->branch_no) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shortname') ? 'is-invalid' : '' }}" type="text" name="shortname" id="shortname" value="{{ old('shortname', $branch->shortname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longname') ? 'is-invalid' : '' }}" type="text" name="longname" id="longname" value="{{ old('longname', $branch->longname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_country') ? 'is-invalid' : '' }}" type="text" name="branch_country" id="branch_country" value="{{ old('branch_country', $branch->branch_country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_currency') ? 'is-invalid' : '' }}" type="text" name="branch_currency" id="branch_currency" value="{{ old('branch_currency', $branch->branch_currency) }}" required>
