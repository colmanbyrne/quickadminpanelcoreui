    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.members.update", [$member->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_no') ? 'is-invalid' : '' }}" type="number" name="member_no" id="member_no" value="{{ old('member_no', $member->member_no) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $member->surname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text" name="firstname" id="firstname" value="{{ old('firstname', $member->firstname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prefix') ? 'is-invalid' : '' }}" type="text" name="prefix" id="prefix" value="{{ old('prefix', $member->prefix) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partner') ? 'is-invalid' : '' }}" type="text" name="partner" id="partner" value="{{ old('partner', $member->partner) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organisation_name') ? 'is-invalid' : '' }}" type="text" name="organisation_name" id="organisation_name" value="{{ old('organisation_name', $member->organisation_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('town') ? 'is-invalid' : '' }}" type="text" name="town" id="town" value="{{ old('town', $member->town) }}" required>
                @if($errors->has('town'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('county') ? 'is-invalid' : '' }}" type="text" name="county" id="county" value="{{ old('county', $member->county) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_code') ? 'is-invalid' : '' }}" type="text" name="post_code" id="post_code" value="{{ old('post_code', $member->post_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tel_no') ? 'is-invalid' : '' }}" type="text" name="tel_no" id="tel_no" value="{{ old('tel_no', $member->tel_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mob_no') ? 'is-invalid' : '' }}" type="text" name="mob_no" id="mob_no" value="{{ old('mob_no', $member->mob_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_2') ? 'is-invalid' : '' }}" type="email" name="email_2" id="email_2" value="{{ old('email_2', $member->email_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_status') ? 'is-invalid' : '' }}" type="text" name="email_status" id="email_status" value="{{ old('email_status', $member->email_status) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_status') ? 'is-invalid' : '' }}" type="text" name="sms_status" id="sms_status" value="{{ old('sms_status', $member->sms_status) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mem_year') ? 'is-invalid' : '' }}" type="text" name="mem_year" id="mem_year" value="{{ old('mem_year', $member->mem_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mem_fee') ? 'is-invalid' : '' }}" type="text" name="mem_fee" id="mem_fee" value="{{ old('mem_fee', $member->mem_fee) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mem_fee_currency') ? 'is-invalid' : '' }}" type="text" name="mem_fee_currency" id="mem_fee_currency" value="{{ old('mem_fee_currency', $member->mem_fee_currency) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_method') ? 'is-invalid' : '' }}" type="text" name="pay_method" id="pay_method" value="{{ old('pay_method', $member->pay_method) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_joined') ? 'is-invalid' : '' }}" type="text" name="date_joined" id="date_joined" value="{{ old('date_joined', $member->date_joined) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_renewed') ? 'is-invalid' : '' }}" type="text" name="date_renewed" id="date_renewed" value="{{ old('date_renewed', $member->date_renewed) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_card_issued') ? 'is-invalid' : '' }}" type="text" name="date_card_issued" id="date_card_issued" value="{{ old('date_card_issued', $member->date_card_issued) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_dd_issued') ? 'is-invalid' : '' }}" type="text" name="date_dd_issued" id="date_dd_issued" value="{{ old('date_dd_issued', $member->date_dd_issued) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_cancelled') ? 'is-invalid' : '' }}" type="text" name="date_cancelled" id="date_cancelled" value="{{ old('date_cancelled', $member->date_cancelled) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('mem_notes') ? 'is-invalid' : '' }}" name="mem_notes" id="mem_notes">{{ old('mem_notes', $member->mem_notes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('updated_by') ? 'is-invalid' : '' }}" type="text" name="updated_by" id="updated_by" value="{{ old('updated_by', $member->updated_by) }}">
