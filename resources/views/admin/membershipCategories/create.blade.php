    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.membership-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category_type') ? 'is-invalid' : '' }}" type="text" name="category_type" id="category_type" value="{{ old('category_type', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mem_fee') ? 'is-invalid' : '' }}" type="number" name="mem_fee" id="mem_fee" value="{{ old('mem_fee', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fee_add') ? 'is-invalid' : '' }}" type="number" name="fee_add" id="fee_add" value="{{ old('fee_add', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('curr_symbol') ? 'is-invalid' : '' }}" type="text" name="curr_symbol" id="curr_symbol" value="{{ old('curr_symbol', '') }}">
