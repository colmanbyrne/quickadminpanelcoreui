    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.update", [$asset->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('asset_branch') ? 'is-invalid' : '' }}" name="asset_branch_id" id="asset_branch_id" required>
                    @foreach($asset_branches as $id => $asset_branch)
                        <option value="{{ $id }}" {{ (old('asset_branch_id') ? old('asset_branch_id') : $asset->asset_branch->id ?? '') == $id ? 'selected' : '' }}>{{ $asset_branch }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('asset_type') ? 'is-invalid' : '' }}" name="asset_type_id" id="asset_type_id">
                    @foreach($asset_types as $id => $asset_type)
                        <option value="{{ $id }}" {{ (old('asset_type_id') ? old('asset_type_id') : $asset->asset_type->id ?? '') == $id ? 'selected' : '' }}>{{ $asset_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asset_year') ? 'is-invalid' : '' }}" type="text" name="asset_year" id="asset_year" value="{{ old('asset_year', $asset->asset_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_purchased') ? 'is-invalid' : '' }}" type="text" name="date_purchased" id="date_purchased" value="{{ old('date_purchased', $asset->date_purchased) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="number" name="value" id="value" value="{{ old('value', $asset->value) }}" step="0.01">
                @if($errors->has('value'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_value') ? 'is-invalid' : '' }}" type="text" name="date_value" id="date_value" value="{{ old('date_value', $asset->date_value) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('rep_value_date') ? 'is-invalid' : '' }}" type="text" name="rep_value_date" id="rep_value_date" value="{{ old('rep_value_date', $asset->rep_value_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rep_value') ? 'is-invalid' : '' }}" type="number" name="rep_value" id="rep_value" value="{{ old('rep_value', $asset->rep_value) }}" step="0.01">
