                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('membership_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.membership-categories.index') }}">
                                            {{ trans('cruds.membershipCategory.title') }}
                                        </a>
                                    @endcan
                                    @can('membership_status_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.membership-statuses.index') }}">
                                    ...
                                    @can('rally_event_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.rally-events.index') }}">
                                            {{ trans('cruds.rallyEvent.title') }}
                                        </a>
                                    @endcan
                                    @can('rally_user_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.rally-users.index') }}">
